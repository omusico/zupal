...
class Zupal_Table_Musicbrainz_L_Album_Album extends Zupal_Table_Abstract
{

    protected $_id_field = 'id';

    protected $_name = 'l_album_album';

    public function create_table()
    {
        Zend_Db_Table_Abstract::getDefaultAdapter()->query("CREATE TABLE `l_album_album` (
          `id` int(11) NOT NULL,
