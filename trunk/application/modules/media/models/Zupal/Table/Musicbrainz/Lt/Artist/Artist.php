...
class Zupal_Table_Musicbrainz_Lt_Artist_Artist extends Zupal_Table_Abstract
{

    protected $_id_field = 'id';

    protected $_name = 'lt_artist_artist';

    public function create_table()
    {
        Zend_Db_Table_Abstract::getDefaultAdapter()->query("CREATE TABLE `lt_artist_artist` (
          `id` int(11) NOT NULL,
