 ...
 * @author daveedelhart
 */
abstract class Xtractlib_Domain_Abstract{
    ...
    protected function load ($pID) {
        ...
        if ($pID):
            ...
            if ($hits):
                ...
                $log = Xtract_Module_Manager::getInstance()->get('people')->logger();
...
/* @@@@@@@@@@@@@@@@@@@@@@@@@@@@@ enum_field @@@@@@@@@@@@@@@@@@@@@@@@@@@@@ */
    ...
    public function enum_field ($pField) {
        ...
        if (!array_key_exists($pField, $this->_enum_fields)):
            $this->_enum_fields[$pField] = new Xtract_Domain_Enum($this, $pField);
        endif;
