...
class Zupal_Table_Musicbrainz_L_Artist_Track extends Zupal_Table_Abstract
{

    protected $_id_field = 'id';

    protected $_name = 'l_artist_track';

    public function create_table()
    {
        Zend_Db_Table_Abstract::getDefaultAdapter()->query("CREATE TABLE `l_artist_track` (
          `id` int(11) NOT NULL,
